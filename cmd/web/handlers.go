...
import (
	...
	"github.com/andruixxd31/snippet-box/internal/validator"
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "Your signup was succesful. Please login")
}
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(form.NotBlank(form.Email), "email", "This field cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must ba a valid email address")
	form.CheckField(form.NotBlank(form.Password), "password", "This field cannot be blank")
